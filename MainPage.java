...
public class MainPage implements ActionListener {
    ...
    public void Contect(){
        ...
        cp2.add(cc);
        Font cf1=new Font("Serief",Font.BOLD,20);
        ce=new JLabel("By Email:");
        ce.setBounds(10, 170, 120, 30);
        ce.setFont(cf1);
        ce.setForeground(Color.BLACK);
        cp3.add(ce);
        cee=new JLabel("admin.group3clsu@gmail.com");
        ...
        cp3.add(ft);
        tfl=new JLabel("Uttarakhand Election");
